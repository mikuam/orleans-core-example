...
namespace MichalBialecki.com.OrleansCore.AccountTransfer.Host
{
    ...
    {
        private const string CosmosBDConnectionString = "DefaultEndpointsProtocol=https;AccountName=bialecki-t;AccountKey=[yourPrivateKey];TableEndpoint=https://bialecki-t.table.cosmosdb.azure.com:443/;";
